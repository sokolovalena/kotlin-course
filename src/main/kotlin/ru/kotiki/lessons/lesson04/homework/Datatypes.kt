package org.example.ru.kotiki.lessons.lesson04.homework
...
class Datatypes {
    ...
    //val v6 = FALSE - или false или "FALSE"
    val v7: Char = 'c'
    val v8: Int = 500
    ...
    val v19: Float = 5.75f
  //  val v20 = `1.414` -- обратные кавычки, или убираем, или двойные
    val v21: String = "Artificial Intelligence"
  //  val v22 = arrayOf('x', "A") -- в массиве только элементы одного типа
  ...
  //  val v30 = FALSE -- или false или "FALSE"
    val v31: Double = 0.007
  //  val v32 = “🤯” -- обратные кавычки
    val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
  //  val v34 = ‘65535’ -- в char только один символ может быть
  ...
  //  val v44 = TRUE --или true или "TRUE"
}

//Подбери подходящий тип который будет:
//
//Хранить букву, на которую указывает палец медиума во время спиритического сеанса. = Char
//Хранить количество ложек сахара, которые я кладу в одну чашку чая. = Int
//Хранить список расходов на доставку еды, чтобы ещё раз убедиться, что готовить было дешевле. = List<Int>
...
//Хранить список тем для митингов, которые на самом деле никому не нужны. = Set<String>